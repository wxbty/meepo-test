...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="order" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.tuya.txc.dubbo.OrderServiceImpl %CMD_LINE_ARGS%
